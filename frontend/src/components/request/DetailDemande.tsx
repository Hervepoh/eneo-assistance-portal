          ...
          <div>
            ...
            <div className="flex items-center space-x-4 text-sm text-gray-600">
              <div className="flex items-center space-x-1">
                ...
                <span>{demande?.requestor?.name} </span>
              </div>
              <div className="flex items-center space-x-1">
              ...
              <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <p className="text-gray-900">{demande?.requestor?.name} </p>
                    <p className="text-sm text-gray-600">{demande?.requestor?.email}</p>
                  </div>
                  <div>
                    <label className="text-sm font-medium text-gray-500">Département</label>
                    <p className="text-gray-900">{demande?.requestor?.email}</p>
                  </div>
